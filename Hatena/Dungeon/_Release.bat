...
C:\Factory\SubTools\CallConfuserCLI.exe Dungeon\Dungeon\bin\Release\Dungeon.exe out\Dungeon.exe
rem COPY /B Dungeon\Dungeon\bin\Release\Dungeon.exe out
...
C:\Factory\SubTools\zip.exe /PE- /RVE- /G out Dungeon
